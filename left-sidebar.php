    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu"><!--- Sidemenu -->
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-format-underlined"></i> <span> KuzaForms </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li><a href="forms.php">All Forms</a></li>
                        <li><a href="single-form.php">Add Form</a></li>
                    </ul>
                </li>
                <li class="has_sub">
