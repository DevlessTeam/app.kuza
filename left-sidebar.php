    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu"><!--- Sidemenu -->
            <ul>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-format-underlined"></i> <span> Products </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled">
                        <li><a href="javascript:void(0);">List Products</a></li>
